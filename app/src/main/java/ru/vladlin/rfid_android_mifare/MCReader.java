...
import ru.vladlin.rfid_android_mifare.Preferences.Preference;
import ru.vladlin.rfid_android_mifare.Common.Operations;
...
public class MCReader {
     ...
     * .Common.Operations, boolean, boolean)}) of the
     * Access Conditions.
